...
import img from './slack_logo.svg';
import imgSlides from './slide.png';
import swal from 'sweetalert';
import slides from '../../../assets/Slides_Henry.pdf'
			...
			<nav className="nav__links">
				...
				<a href="https://soyhenry.slack.com" target='_blank'>
					<button>
					 ...
					 <button onClick={sweetSlides}>SLIDES
						<img src={imgSlides} />
					</button>
		 
				
				<button onClick={sweetAttendance}>ASISTENCIAS AL SUP</button> {/* las asistencias seran mostradas x/total */}
